...
//                         await conn.query(`
//                         select Skill.skillName, Complexity.Name, Sum(AssessmentDetails.score) as "Totalscore",count(Questions.skillId)as 
...
//                         group by Questions.skillId,Skill.skillName,Complexity.Name
//                         `,(err, val) => {
//                             if (val) {
//                                 const array = {
//                                     val
